...
/* Bit Masking Macros  */
#define ADC_PRE_MASK				0b11111000			//Mask for Prescaler 3 bits		[ADCSRA] ADOS0..ADOS2
#define ADC_CH_MASK				    0b11100000			//Mask for MUX Selection 5 bits	[ADMUX]  MUX0..MUX4
